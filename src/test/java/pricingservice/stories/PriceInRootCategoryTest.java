...
public class PriceInRootCategoryTest extends AcceptanceTest {
    ...
    public InjectableStepsFactory stepsFactory() {
        ...
        return new InstanceStepsFactory(configuration(),
                new PriceInRootCategorySteps(pricingApiClient.getPricingApi(), priceCalculationReference),
                new PriceAssertionSteps(pricingApiClient.getPricingApi(), priceCalculationReference));
    }
}
