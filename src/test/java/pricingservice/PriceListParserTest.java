...
public class PriceListParserTest {
  ...
  public void shouldParsePriceListTree() throws Exception {
    String priceListsTree = "# 0: BOLD: 0.70, HIGHLIGHT: 1.00, PHOTO: 0.50\n"
    ...
    assertThatPriceList(forCategory(0)).hasFee(BOLD, "0.70")
            .hasFee(HIGHLIGHT, "1.00").hasFee(PHOTO, "0.50");
    assertThatPriceList(forCategory(1)).hasFee(BOLD, "0.60").hasFee(PHOTO,
            "0.40");
    assertThatPriceList(forCategory(2)).hasFee(BOLD, "0.50");
    assertThatPriceList(forCategory(3)).hasFee(BOLD, "0.40").hasFee(PHOTO,
            "0.30");
  ...
  static class PriceListAssert {
    ...
    public PriceListAssert hasFee(PromoOption promoOption, String fee) {
      Assertions.assertThat(priceList.getFee(promoOption)).isEqualTo(
              new BigDecimal(fee));
      return this;
    }
  }
